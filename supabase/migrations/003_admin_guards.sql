-- =============================================
-- CRS Brants â€” 003: Admin-only guards
...
CREATE OR REPLACE FUNCTION crs_brants_is_admin()
RETURNS BOOLEAN
SECURITY DEFINER
...
GRANT EXECUTE ON FUNCTION crs_brants_is_admin() TO authenticated;
...
--
-- DROP FUNCTION IF EXISTS crs_brants_is_admin();
--
-- DROP FUNCTION IF EXISTS crs_brants_admin_list_users();
-- CREATE OR REPLACE FUNCTION crs_brants_admin_list_users()
-- RETURNS TABLE(
