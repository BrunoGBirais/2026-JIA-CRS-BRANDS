-- =============================================
-- CRS Brants â€” 001: User CRUD Functions
...
GRANT EXECUTE ON FUNCTION crs_brants_admin_update_user(UUID, TEXT) TO authenticated;
GRANT EXECUTE ON FUNCTION crs_brants_admin_delete_user(UUID) TO authenticated;

NOTIFY pgrst, 'reload schema';

-- =======  DOWN  ========
-- REVOKE EXECUTE ON FUNCTION crs_brants_admin_list_users() FROM authenticated;
-- REVOKE EXECUTE ON FUNCTION crs_brants_admin_confirm_user(UUID) FROM authenticated;
-- REVOKE EXECUTE ON FUNCTION crs_brants_admin_update_user(UUID, TEXT) FROM authenticated;
-- REVOKE EXECUTE ON FUNCTION crs_brants_admin_delete_user(UUID) FROM authenticated;
--
-- DROP FUNCTION IF EXISTS crs_brants_admin_list_users();
-- DROP FUNCTION IF EXISTS crs_brants_admin_confirm_user(UUID);
-- DROP FUNCTION IF EXISTS crs_brants_admin_update_user(UUID, TEXT);
-- DROP FUNCTION IF EXISTS crs_brants_admin_delete_user(UUID);
--
-- NOTIFY pgrst, 'reload schema';
